...
function Navbar() {
  ...
  return (
    <>
      <div className="hidden lg:flex top-[2vh] justify-around items-center w-[100vw] h-[8vh] absolute z-10">
      ...
      <div className="bg-[#1849C6] flex lg:hidden px-[4vw] justify-between items-center w-[100vw] h-[10vh]  z-10">
        <Link href="/">
          <div className="cursor-pointer flex items-center space-x-2">
            ...
            <h1 className="shadow-2xl font-semibold text-white text-[5vw] lg:text-[1.40vw]">
              StorageConnect
            </h1>
          </div>
        </Link>
